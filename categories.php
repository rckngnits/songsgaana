...
<article class="col-md-10">
	<section class="row">
		...
		$catsql = "select * from categories order by Subcategory" ;
...
<div class="col-md-6"> 
    <table width="100%" border="1">
		...
		if($sub_category ==1){ ?>
				...
				<?php	$qry = "select * from cat_songs_rel where Category_Id='$Category_Id' LIMIT 3";
        ...
        <?Php if ($i%2 != 0) {?>
        <tr class="odd">
            <td><strong>  <?php  echo $albumRows['Album_Name']; ?>  </strong> <br> <?php  echo $albumRows['Album_Artist']; ?> </td>
        ...
        <?Php if ($i%2 != 0) {?>
        <tr class="odd">
            <td><strong> <?php echo $albumRows['Song_Name']; ?>  </strong> <br> <?php  echo $albumRows['Song_Artist']; ?> </td>
        </tr>
        <?Php } else {?>
            <td><a href="album.php?albumid=<?php echo $albumRows['Album_Id']; ?>"> <?php echo "View Album"; ?> </a></td>
        <tr class="even">
